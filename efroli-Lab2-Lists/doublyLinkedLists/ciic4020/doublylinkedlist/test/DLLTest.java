package ciic4020.doublylinkedlist.test;


import ciic4020.doublylinkedlist.DLLFactory;
import ciic4020.doublylinkedlist.List;
import ciic4020.doublylinkedlist.ListFactory;

public class DLLTest {

	public static void main(String[] args) {
		ListFactory<String> factory = new DLLFactory<String>();
	...
	//Exercise 2 Tester
		System.out.println("");
		System.out.println("EXERCISE 2: REPLACE ALL (DoublyLinkedList)");
	...
	//Exercise 3 Tester
		System.out.println("");
		System.out.println("EXERCISE 3: REVERSE (DoublyLinkedLists)");
